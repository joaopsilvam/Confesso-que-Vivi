<html>
  ...
  <body>
  	...
  	<div id="direita">
  		...
  		<div class="titulo2" style="padding: 2%;">Meus Vídeos</div>
  		<div id="feed">
  			<div id="videos">
  				<div class="video">
  					<iframe width="100%" height="300px" src="https://www.youtube.com/embed/oQ64P5arYkI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
   				...
   				<div class="video">
   					<iframe width="100%" height="300px" src="https://www.youtube.com/embed/A9kiJgo_F9E" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					<div class="titulo2">Terceiro Congresso Cientifico de Fisioterapia</div>
					<div class="subtitulo2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
  				</div>
   				<div class="video">
   					<iframe width="100%" height="300px" src="https://www.youtube.com/embed/MnayBl0eWTQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					<div class="titulo2">Seminário de práticas laboratoriais e convergência jornalística</div>
					<div class="subtitulo2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
  				</div>
  				<div class="video">
  					<iframe width="100%" height="300px" src="https://www.youtube.com/embed/J5hSKsfoIdQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
